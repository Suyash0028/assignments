...
--B
SELECT item AS "Product", id AS "ID", inventory AS "Current Inventory" FROM stock_items WHERE inventory <= 12;

-- 5
--A
SELECT item AS "Kitty Cat", price FROM stock_items WHERE category = "Feline";
--B
SELECT last_name, first_name FROM employees WHERE id = "115";